var rainKonfetti = function(durationInSeconds) {

    console.log("called");

    // make sure animation is just running once
    if (window.isRaining) return;
...
document.addEventListener("DOMContentLoaded", function() {
        ...
        // add confetti canvas to body
        document.body.innerHTML += '<canvas id="confetti" style="display:none" class="confetti-default" width="1" height="1"></canvas>';
